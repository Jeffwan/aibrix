...
func (f *fakeRuntime) SetKVBudget(_ context.Context, _ string, _ int, _ *KVBudgetRequest) error {
	return nil
}
...
func warmPod(name, poolName string, enabled bool, phase corev1.PodPhase) *corev1.Pod {
	...
	if enabled {
		labels[constants.ModelPoolLabelEnabled] = "true"
	}
	return &corev1.Pod{
...
// PoolSelector are considered candidates.
